...
The string has a length greater or equal to one and contains only letters from ato z.*/
    ...
    // MAP FILTER FOREACH 
     ...
     const companies=[
       ...
       {name: "Company tree", category: "Auto", start:1999 , end:2007 },
       {name: "Company four", category: "Retail", start: 1985, end:2000 },
       {name: "Company five", category: "Technology", start: 2009, end:2014 },
       {name: "Company six", category: "Finance", start:1987 , end:2010 },
       {name: "Company seven", category: "Auto", start: 2011, end:2016 },
       {name: "Company eight", category: "Retail", start:1981 , end:1986 }
     ]

     const ages = [33,43,52,12,75,20,18,42,46,38,32,50,20,26];
//for
     for(let i=0; i < companies.length; i++){
       console.log(companies[i])
     }

     //foreach   it is syncronics call back
companies.forEach(function(eachCompay,index){
    console.log(eachCompay.name)
})

//Filter things form the array
...
const retaisCompanies = companies.filter(function(compani){
   if(compani.category == "Retail")
   return true
})
